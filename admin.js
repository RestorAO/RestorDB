...
productForm.addEventListener("submit", function (event) {
    ...
    xhr.open('POST', "https://market-0951.restdb.io/rest/products");
    xhr.setRequestHeader("content-type", "application/json");
    xhr.setRequestHeader("x-apikey", "680e1efd72702c2ba8b3d315");
...
xhr.open("GET", "https://market-0951.restdb.io/rest/orders")
